...
createUser("Test1", "player1", "password123")  # First attempt to create database "Test1"
# Step 2: Trying to create the same user again (should trigger username already exists message)
createUser("Test1", "player1", "password123")  # This should not create a new database
# Step 3: Attempt to create a different user
createUser("Test2", "player2", "password789")  # Create a new database "Test2"
